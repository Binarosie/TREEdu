...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(prePostEnabled = true) // ← QUAN TRỌNG: Enable @PreAuthorize
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Tất cả endpoints khác cần authenticate
                        // Phân quyền chi tiết sẽ dùng @PreAuthorize trong controller
