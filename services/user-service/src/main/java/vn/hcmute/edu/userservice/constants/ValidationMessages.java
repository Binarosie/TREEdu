...
public final class ValidationMessages {
    ...
    // MEMBER required field messages
    public static final String MEMBER_FULLNAME_REQUIRED = "Full name is required";
    public static final String MEMBER_EMAIL_REQUIRED = "Email is required";
    public static final String MEMBER_PHONENUMBER_REQUIRED = "Phone number is required";
    public static final String MEMBER_BIRTHDAY_REQUIRED = "Birthday is required";
    public static final String MEMBER_ADDRESS_REQUIRED = "Address is required";

    // MEMBER format validation messages
    public static final String MEMBER_EMAIL_INVALID = "Email format is invalid";
    public static final String MEMBER_PHONENUMBER_INVALID = "Phone number must be 10 digits or start with +84";
    public static final String MEMBER_FULLNAME_SIZE = "Full name must be between 2 and 100 characters";

    // MEMBER business rule messages
    public static final String MEMBER_EMAIL_DUPLICATE = "Email already exists in the system";
    public static final String MEMBER_PHONENUMBER_DUPLICATE = "Phone number already exists in the system";
    public static final String MEMBER_AGE_INVALID = "MEMBER must be at least 18 years old";
    public static final String MEMBER_BIRTHDAY_FUTURE = "Birthday cannot be in the future";
