...
import vn.hcmute.edu.authservice.dto.CreateRoleDto;
import vn.hcmute.edu.authservice.dto.PermissionResponse;
import vn.hcmute.edu.authservice.dto.RolePermissionRequest;
import vn.hcmute.edu.authservice.dto.RoleResponse;
import vn.hcmute.edu.authservice.mapper.PermissionMapper;
import vn.hcmute.edu.authservice.mapper.RoleMapper;
import vn.hcmute.edu.authservice.response.ResponseData;
import vn.hcmute.edu.authservice.service.iPermissionService;
import vn.hcmute.edu.authservice.service.iRoleService;
